...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal bool IncluirBeneficiarios(List<Beneficiario> beneficiarios)
        {
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            Cliente cli = Converter(ds).FirstOrDefault();

            if (cli != null)
            {
                List<System.Data.SqlClient.SqlParameter> parametrosBeneficiario = new List<System.Data.SqlClient.SqlParameter>();
                parametrosBeneficiario.Add(new System.Data.SqlClient.SqlParameter("Id", Id));

                ds = base.Consultar("FI_SP_ConsBeneficiario", parametrosBeneficiario);
                cli.Beneficiarios = ConverterBeneficiario(ds);
            }
